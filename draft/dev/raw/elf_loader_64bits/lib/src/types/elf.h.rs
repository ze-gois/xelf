...
enum SectionFlags {
    ...
    OS_NONCONFORMING = 0x100,	/* Non-standard OS specific handling
        required */
    GROUP = 0x200,	/* Section is member of a group.  */
    TLS = 0x400,	/* Section hold thread-local data.  */
    COMPRESSED = 0x800,	/* Section with compressed data. */
    MASKOS = 0x0ff00000,	/* OS-specific.  */
    MASKPROC = 0xf0000000,	/* Processor-specific */
    GNU_RETAIN = 0x200000,  /* Not to be GCed by linker.  */
    ORDERED = 0x40000000,	/* Special ordering requirement
        (Solaris).  */
    EXCLUDE = 0x80000000,	/* Section is excluded unless
