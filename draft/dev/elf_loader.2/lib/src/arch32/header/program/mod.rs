...
impl Header {
    ...
    pub fn load_from_memmap(
        ...
        Self {
            ...
            filesz: data::read_and_seek_word(filemap, &mut offset, &endianess),
            memsz: data::read_and_seek_word(filemap, &mut offset, &endianess),
            flags: data::read_and_seek_word(filemap, &mut offset, &endianess),
            align: data::read_and_seek_word(filemap, &mut offset, &endianess),
        }
    }
}
